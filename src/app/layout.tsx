...
export const metadata: Metadata = {
  ...
  description:
    "Premier entertainment and business hub focused on promoting artists and creating premium content.",
  keywords:
    "music production, artist management, entertainment, booking, talent agency",
